...
const footerLinks = {
  ...
  services: [
    { label: 'CI/CD Setup', href: '/#services' },
    { label: 'Infrastructure Setup', href: '/#services' },
        ...
        <div className="py-12 md:py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs mb-6 leading-relaxed">
              Elite infrastructure engineering for fast-moving startups. 
              We build the systems that let you ship with confidence.
            </p>
        ...
        <div className="py-6 border-t border-border/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="font-mono text-sm text-muted-foreground">
              <span className="text-primary">$</span> echo &quot;© {new Date().getFullYear()} DevOpsFlow. All rights reserved.&quot;
            </div>
